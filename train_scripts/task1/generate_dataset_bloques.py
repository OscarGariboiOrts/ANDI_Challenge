...
def main(args):
    ...
    X1, Y1, X2, Y2, X3, Y3 = AD.andi_dataset(N = int(args.number), tasks = int(args.task), dimensions = int(args.dimension), min_T=int(args.min), max_T=int(args.max)+1, save_dataset = True)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--min", help="Minimum size of the trajectories", default="10")
    parser.add_argument("--max", help="Maximum size of the trajectories", default="1000")
