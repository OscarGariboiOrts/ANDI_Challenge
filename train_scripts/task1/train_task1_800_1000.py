...
def main(args):
    """
        ...
        Script to train a model for diffusion exponent regression for trajectories of length between 800 and 1000 under the scope of the ANDI Challenge.
    ...
    mc = ModelCheckpoint(path_to_model + 'task1_len_800_1000-{epoch:03d}-{val_mean_absolute_error:.4f}.h5', monitor='val_mean_absolute_error', mode='min', verbose=0, save_best_only=True)
